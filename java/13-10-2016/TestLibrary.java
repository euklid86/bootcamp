...
public static void main(String args[]){
	...
	ans = scanner.nextLine();
		...
		if (Integer.parseInt(ans)==2){
			System.out.print("Give the title: ");
			String search=scanner.nextLine();
			the_guy.findMeBook(search);
			System.out.println("___________________________________________");
			}
		if (Integer.parseInt(ans)==3){
			System.out.print("Give the author: ");
			String search=scanner.nextLine();
			the_guy.findMeBooksFromAuthor(search);
			System.out.println("___________________________________________");
			}
		/*if (Integer.parseInt(ans)==3){
			System.out.print("Give the title:  ");
			...
			Author testAuth = new Author(auth);
			System.out.print("Give the ISBN:  ");
			String isb=scanner.nextLine();
			System.out.print("Give the physical copies:  ");
			int phys=scanner.nextInt();
			System.out.print("Give the available copies:  ");
			int avail=scanner.nextInt();
			System.out.print("Give the rented times:  ");
			int rent=scanner.nextInt();
			Book testbook = new Book(titl,testAuth,isb,phys,avail,rent);
			books[books[0].printCount()]=testbook;
			the_guy.findMeAvailableBooks();
			}*/
		}while (Integer.parseInt(ans)!=4);
	}
}