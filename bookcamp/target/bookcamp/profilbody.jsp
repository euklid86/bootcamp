    			...
    			<div class="main-login-form">
    				<div class="login-group">
    					...
    					<div class="form-group">
    						...
    						<input type="password" class="form-control" id="password" name="password" placeholder="old password" value="<%out.print(u.getPassword()); %>"placeholder="<%out.print(u.getPassword()); %>" disabled="disabled">
    					</div>
    					<div class="form-group">
    					...
    					<div class="form-group">
    						...
    						<input type="password" class="form-control" id="conpassword" name="password_confirm" placeholder="confirm new password">
    					</div>
